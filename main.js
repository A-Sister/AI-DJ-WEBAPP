...
function gotPoses(results){
    if(results.length > 0) {
        ...
        console.log("Right Wrist Score "+ score_rightWrist+" Left Wrist Score: "+score_leftWrist);
    ...
    if(score_rightWrist > 0.2) {
        ...
        song1.stop();
         ...
         if(song_status2 == false) {
             song2.play();
             document.getElementById("name").innerHTML = "Song Playing: Harry Potter Theme Song";
         }
    }
